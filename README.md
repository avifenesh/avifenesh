...
- **[Valkey](https://github.com/valkey-io/valkey)** - contributor to the in-memory datastore core (compatibility, CLI behavior); started the official **[valkey-skills](https://github.com/valkey-io/valkey-skills)** and private Bedrock-AgentCore PR-review automation.
